        ...
        private static void IfComparisonExample()
        {
            ...
            if (x >= 0 && y >= 0)
            {
                if (x != y)
                {
                    ...
                    {
                        sum = y - x;
                        Console.WriteLine("X value less than у by " + sum);
                    }
                    if (x > y)
                    {
                        sum = x - y;
                        Console.WriteLine("X value more than у by " + sum);
                    }
                }
                else Console.WriteLine("Values are the same");
            }
            else Console.WriteLine("Value of x and y must be larger than ZERO or the same");
        }               
    }
}
